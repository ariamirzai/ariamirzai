*Mainly C/C++ or Python development for embedded Linux systems, utilising the Qt framework. My work is focused on applied research in safety and cybersecurity for reliable and autonomous systems.*
...
- [**WayWiseR:**](https://github.com/RISE-Dependable-Transport-Systems/WayWiseR) Integration of WayWise with [ROS2](https://docs.ros.org/) for extended functionality
